        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl lg:text-2xl text-white/90 mb-8 max-w-2xl leading-relaxed">
              Leading manufacturer of premium digital and electronic weighing
              scales. Trusted by businesses across India for accuracy,
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(`tel:+91${ARYA_PHONE_NUMBER}`, "_self")
                }
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="text-white/80">Satisfied Dealers</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-3xl font-bold text-accent mb-2">100%</div>
